...
import { School, MenuBook, Facebook, Twitter, Instagram, YouTube, X } from '@mui/icons-material';
    ...
    return (
        <Box sx={{ mb: 6 }}>
            ...
            <Box sx={{ display: 'flex', gap: 3, flexDirection: { xs: 'column', sm: 'row' } }}>
                ...
                >
                    <Typography variant="h3" sx={{ color: 'white', fontFamily: 'serif', fontStyle: 'italic' }}>
                        ¶T
                    </Typography>
                </Box>
                ...
                <Box>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                        ...
                        <IconButton size="small"><X fontSize="small" /></IconButton>
                        <IconButton size="small"><Instagram fontSize="small" /></IconButton>
                        <IconButton size="small"><YouTube fontSize="small" /></IconButton>
                    </Box>
                </Box>
            </Box>
        </Box>
