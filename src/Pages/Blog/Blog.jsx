...
import { Box, Container, Typography, Grid, Pagination, InputAdornment, TextField, Stack } from '@mui/material';
...
const blogPosts = Array(9).fill({
    ...
    author: 'John Doe',
    date: '12/10/25',
    image: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60' // Example placeholder
});
...
const relatedPosts = Array(6).fill({
    ...
    author: 'John Doe',
    date: '12/10/25',
    image: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60' // Example placeholder
});
    ...
    return (
        <Box sx={{ bgcolor: colors.mainBg, minHeight: '100vh', py: 8 }}>
            <Container maxWidth="lg" sx={{ pt: 4 }}>
                ...
                {/* Featured Section */}
                <Box sx={{ mb: 8 }}>
                    <Typography variant="title" sx={{ color: colors.primary, mt: 4, mb: 2 }}>
                        Featured
                    </Typography>
